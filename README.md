...
python -m app.seed                                   # демо-данные (54 скважины, 14 БС)
uvicorn app.main:app --host 0.0.0.0 --port 8000
```

Откройте `http://localhost:8000` и войдите под одним из демо-пользователей:

| Логин  | Пароль | Роль | Зона ответственности |
|--------|--------|------|----------------------|
| admin  | admin  | администратор | все объекты |
| cdn1   | cdn1   | уровень ЦДН | скважины всех ГЗУ, входящих в ЦДН-1 |
| gzu11  | gzu11  | уровень ГЗУ | только скважины ГЗУ-11 |
